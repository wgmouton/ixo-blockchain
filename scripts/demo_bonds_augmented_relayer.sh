...
ixod_tx bonds buy 100000abc 100000000000uixo "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
ixod_q bank balances "$MIGUEL_ADDR"

echo "Francesco buys 100000abc..."
ixod_tx bonds buy 100000abc 100000000000uixo "$BOND_DID" "$FRANCESCO_DID_FULL"
...
echo "Miguel buys 100000abc..."
ixod_tx bonds buy 100000abc 200000000000uixo "$BOND_DID" "$MIGUEL_DID_FULL"
echo "Miguel's account..."
ixod_q bank balances "$MIGUEL_ADDR"
...
ixod_tx bonds buy 1abc 2000000uixo "$BOND_DID" "$MIGUEL_DID_FULL"
