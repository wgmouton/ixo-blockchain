...
ixocli tx bonds buy 100000abc 100000000000uixo "$BOND_DID" "$MIGUEL_DID_FULL" --broadcast-mode block --gas-prices="$GAS_PRICES" -y
echo "Miguel's account..."
ixocli q auth account "$MIGUEL_ADDR"

echo "Francesco buys 100000abc..."
ixocli tx bonds buy 100000abc 100000000000uixo "$BOND_DID" "$FRANCESCO_DID_FULL" --broadcast-mode block --gas-prices="$GAS_PRICES" -y
...
echo "Miguel buys 100000abc..."
ixocli tx bonds buy 100000abc 200000000000uixo "$BOND_DID" "$MIGUEL_DID_FULL" --broadcast-mode block --gas-prices="$GAS_PRICES" -y
echo "Miguel's account..."
ixocli q auth account "$MIGUEL_ADDR"
...
ixocli tx bonds buy 1abc 2000000uixo "$BOND_DID" "$MIGUEL_DID_FULL" --broadcast-mode block --gas-prices="$GAS_PRICES" -y
